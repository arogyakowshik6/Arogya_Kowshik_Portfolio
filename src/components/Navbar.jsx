  ...
  return (
    ...
    >
      <div className="container mx-auto flex justify-between items-center">
        ...
        >
          <span className="text-red-600">A</span>rogya <span className="text-red-600">K</span>owshik
        </motion.h1>
        ...
        {/* 🔥 BUTTON */}
          <motion.a
  href="/CV/Kuppala%20Arogya%20Kowshik-%20CV.pdf"
  download="Kuppala_Arogya_Kowshik_CV.pdf" /* 👈 This forces the download and renames the file nicely */
  target="_blank" /* Optional: Fallback to ensure it doesn't navigate away if download behavior fails */
